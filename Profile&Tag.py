...
def main():
    print('1 : apply profile to accouts of selected group')
...
def apply_profile():
    ...
    for name in dic_account_name2id:
        ...
        environment = dic['data']['attributes']['environment']
        ...
        if profile_name not in tags:
            ...
            dic['data']['attributes']['environment'] = environment
